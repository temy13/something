...
$stmt = $mysqli->prepare("UPDATE keywords
    SET twitter_user_id = ?, keyword = ?, count = ?, timing_type = ?, interval_time = ?,
...
$stmt->bind_param('ssissssssssssssssssssssssssssi', $twitter_user_id, $keyword, $count, $timing_type, $interval_time, $mt[0],
