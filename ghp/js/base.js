! function(t) {
  ...
  (function(t) {
    ...
    e.a = function() {
      ...
      return e.prototype.resetVariables = function() {
        this.colors = [n.a.COLORS.YELLOW, n.a.COLORS.WHITE], this.currentColorIndex = 0, this.isHalfWay = !1, this.isNext = !1
  ...
  */
  ...
  e.a = function(t) {
    function e(e) {
      void 0 === e && (e = {}), t.call(this), this.attrs = e, this.fragmentShader = s.a, this.division = 0, this.colorMap = {}, this.colorMap[r.a.COLORS.YELLOW] = "#fcda54", this.colorMap[r.a.COLORS.WHITE] = "#fafafa", this.updateColors(r.a.COLORS.YELLOW, r.a.COLORS.WHITE), this.resetVariables()
    }
